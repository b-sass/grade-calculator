    ...
    <div class="container mt-5" id="terms-container">
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <section>
                    <h2>General Terms</h2>
                    <p>By accessing and placing an order with Grade Flare Calculator, you confirm that you are in agreement with and bound by the terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire website and any email or other type of communication between you and Grade Flare Calculator.</p>
                </section>
